...
public class EntityVillagerPet extends EntityAgeablePet implements IEntityVillagerPet {
    ...
    protected void registerDatawatchers() {
        ...
        registerAccessorValue(HEAD_ROLLING_TIME_LEFT, 0);
        registerAccessorValue(VILLAGER_DATA, new net.minecraft.world.entity.npc.VillagerData(EntityUtils.getTypeFromBiome(BiomeType.PLAINS), VillagerProfession.NONE, 1));
    }
